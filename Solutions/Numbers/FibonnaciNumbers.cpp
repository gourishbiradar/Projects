...
int main(int argc, char** argv)
{
    if(argc<1)
    {
        cout<<"Please enter the term who's fibonnaci value you want to know";
        system("pause");
        return -1;
    }
    cout<<"Fibonnaci "<<atoi(argv[1])<<" is "<<FibonnaciMatrix(atoi(argv[1]))<<endl;
    system("pause");
    return 0;
}